    ...
    cache(key, origin) {
        ...
        this.ids.map((resourceId) => {
            ...
            if (!isAbsolute && originUrl) {
                ...
                const hrefLocation = typeof (window) !== "undefined" ? window.location.href : globalThis.location.origin;
            

                url = new Url(key + base + path, hrefLocation).toString();
            }
